...
\newcommand{\getChairman}{________________}
\newcommand{\getSupervisor}{Eric Sonnendru\"cker}
\newcommand{\getExaminer}{________________}
\newcommand{\getSubmissionDate}{___________}
\newcommand{\getAcceptanceDate}{___________}
