...
![The three axes of the snapshot tensor are (i) dimension, (ii) time and (iii) parameters.](../tikz/tensor_light.png)
![The three axes of the snapshot tensor are (i) dimension, (ii) time and (iii) parameters.](../tikz/tensor_dark.png)
