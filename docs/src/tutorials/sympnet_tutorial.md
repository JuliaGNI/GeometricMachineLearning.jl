...
if Main.output_type == :html_output # hide
    ...
    Plots.plot(Images.load("../tikz/structs_visualization.pdf"), axis=([], false)) # hide
end # hide
```
...
#predictions
la_trajectory = GeometricMachineLearning.iterate(la_nn, ics; n_points = steps_to_plot)
g_trajectory = GeometricMachineLearning.iterate(g_nn, ics; n_points = steps_to_plot)
