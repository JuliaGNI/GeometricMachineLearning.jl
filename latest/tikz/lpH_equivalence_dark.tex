...
\begin{document}
\begin{tikzpicture}[
    node1/.style={rectangle, draw=black!60, fill=mpurple!65, very thick, minimum size=5mm},
    node2/.style={rectangle, draw=black!60, fill=morange!65, very thick, minimum size=5mm},
