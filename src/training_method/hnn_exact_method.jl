...
function loss_single(::TrainingMethod{HnnExactMethod}, nn::NeuralNetwork{<:HamiltonianArchitecture}, qₙ, pₙ, q̇ₙ, ṗₙ, params = nn.params)
...
loss(ti::TrainingMethod{HnnExactMethod}, nn::NeuralNetwork{<:HamiltonianArchitecture}, data::TrainingData{<:DataSymbol{<:DerivativePhaseSpaceSymbol}}, index_batch = eachindex(ti, data), params = nn.params) = 
