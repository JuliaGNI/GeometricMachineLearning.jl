...
ExactLnn(;sqdist = sqeuclidean) = TrainingIntegrators{LnnExactIntegrator, PosVeloAccSymbol, SampledData, typeof(sqdist)}(sqdist)
...
loss(ti::LnnExactIntegrator, nn::LuxNeuralNetwork{<:LagrangianNeuralNetwork}, data::TrainingData{DataSymbol{<:PosVeloAccSymbol}}, index_batch = get_batch(datat), params = nn.params) =
