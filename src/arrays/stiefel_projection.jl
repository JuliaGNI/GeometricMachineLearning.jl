...
Base.vcat(A::AbstractVecOrMat{T}, E::StiefelProjection{T}) where T = vcat(A, E.A)
Base.vcat(E::StiefelProjection{T}, A::AbstractVecOrMat{T}) where T = vcat(E.A, A)
Base.hcat(A::AbstractVecOrMat{T}, E::StiefelProjection{T}) where T = hcat(A, E.A)
Base.hcat(E::StiefelProjection{T}, A::AbstractVecOrMat{T}) where T = hcat(E.A, A)