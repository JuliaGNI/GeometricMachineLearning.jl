...
using GeometricMachineLearning: tensor_inverse4, tensor_inverse5
...
function main(first_dim, second_dim, third_dim, third_tensor_dim)
    ...
    # custom inverse test 
    test_rrule(tensor_inverse4, rand(4, 4, third_dim), check_thunked_output_tangent = false)
    test_rrule(tensor_inverse5, rand(5, 5, third_dim), check_thunked_output_tangent = false)
    # test_rrule(tensor_inverse6, rand(6, 6, third_dim), check_thunked_output_tangent = false)
end
