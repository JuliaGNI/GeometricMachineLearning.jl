using GeometricMachineLearning: tensor_cayley2, tensor_cayley3, tensor_cayley4,
                                tensor_cayley5
...
function check_orthonormal_property(B::AbstractArray)
    for i in axes(B, 3)
        B_temp = @view B[:, :, i]
