...
#   julia --startup-file=no --project=scripts scripts/utilities/convert_jld2_to_h5.jl
#
# One .h5 file per neural network stored in each .jld2 source file. The .jld2 sources are not in
# the repository: this converted the committed weights under docs/src/tutorials/ once, and is kept
# because it is the only record of how the .h5 layout was arrived at.
