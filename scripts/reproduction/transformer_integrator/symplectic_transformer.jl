...
function make_validation_plot(n_steps = n_steps; theme = :dark, symplectic = true)
    ...
    # we use linewidth  = 2
    lines!(ax, (n_steps - (50)):n_steps, dl.input.q[1, (n_steps - (50)):n_steps, index];
        color = mblue, label = "Implicit midpoint", linewidth = 2)
    lines!(ax, (n_steps - (50)):n_steps, prediction1.q[1, (n_steps - (50)):n_steps];
        color = mpurple, label = "Transformer", linewidth = 2)
    symplectic ?
    lines!(ax, (n_steps - (50)):n_steps, prediction2.q[1, (n_steps - (50)):n_steps];
        color = mred, label = "SymplecticTransformerS", linewidth = 2) : false
    symplectic ?
    lines!(ax, (n_steps - (50)):n_steps, prediction3.q[1, (n_steps - (50)):n_steps];
...
CairoMakie.save("Matrix-Softmax-Validation.png", fig_light)
