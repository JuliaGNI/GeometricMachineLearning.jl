...
params = [(α = α̃ ^ 2, N = 200) for α̃ in 0.8:0.1:0.8]
pr = hodeensemble(; timespan = (0.0, 800.0), parameters = params)
...
save("sae_parameters.jld2", "sae_parameters",
...
save("integrator_parameters.jld2", "integrator_parameters",
