...
@safetestset "Method                                                                          " begin
    include("test_method.jl")
end
@safetestset "Matching                                                                        " begin
    include("test_matching.jl")
end
@safetestset "TrainingSet                                                                     " begin
    include("test_trainingSet.jl")
end
@safetestset "Training                                                                        " begin
    include("test_training.jl")
end
@safetestset "NeuralNetSolution                                                               " begin
    include("test_neuralnet_solution.jl")
end
@safetestset "Problem & Integrators                                                           " begin
